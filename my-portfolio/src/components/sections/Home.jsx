    ...
    return <section id="home" className="min-h-screen flex items-center justify-center relative">
        <RevealOnScroll>
            <div className="text-center z-10 px-4">
                <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent leading-tight">Hi, I'm Seemarekha Behera</h1>

                <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                    I’m a Full Stack Developer who loves turning ideas into real-world applications. My passion lies in building scalable, user-friendly solutions that blend clean code with creative design.
                </p>
